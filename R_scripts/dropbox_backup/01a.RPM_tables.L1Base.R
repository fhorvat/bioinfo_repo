...
######################################################## WORKING DIRECTORY
# set working dir
setwd("/common/WORK/fhorvat/Projekti/Svoboda/Dicer_Mili_KO/Analysis/RNAi_piRNA_paper/LINE1_expression/counts/Dicer_Mili_KO/L1Base")
...
# coverage path 
coverage_path <- "/common/WORK/fhorvat/Projekti/Svoboda/Dicer_Mili_KO/Analysis/RNAi_piRNA_paper/LINE1_expression/element_coverage/Dicer_Mili_KO/2019_RNAi_piRNA_file3_L1_table.Dicer_Mili_KO.coverage.csv"
...
coverage_rpm <- 
  coverage_tb %>% 
  dplyr::left_join(., rpm_average, by = c("L1base_id" = "rmsk_id")) %T>% 

...
######################################################## WORKING DIRECTORY
# set working dir
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.MesAur1/raw_rmsk.expression")
...
# clean repeatMasker
rmsk_clean_path <- file.path(genome_dir, "rmsk.MesAur1.0.20160612.RefSeq.clean.fa.out.gz")
...
# save
readr::write_csv(rmsk_coords, file.path(outpath, "rmsk.MesAur1.0.20160612.RefSeq.clean.SINE_LINE_LTRs.geneInfo.csv"))
...
# save
rtracklayer::export.bed(rmsk_bed, file.path(outpath, "rmsk.MesAur1.0.20160612.RefSeq.clean.SINE_LINE_LTRs.bed"))

...
# mapped path
mapped_path <- file.path(experiment_path, "Data/Mapped/STAR_mm10/5_filtered_reads/perfect_reads")
...
openxlsx::write.xlsx(x = counts_df, 
                     file = file.path(outpath, "MosIR_RPM.18to30nt_reads.summary.xlsx"), 
                     asTable = T,
                     sheetName = "mis_0")

...
experiment='hamster_testis_Mov10l.RNAseq'
single_end=FALSE
threads=1
mapped_path='/common/WORK/fhorvat/Projekti/Svoboda/hamster_KO/datasets/hamster_testis_Mov10l.RNAseq/Data/Mapped/STAR_mesAur1'
documentation_path='/common/WORK/fhorvat/Projekti/Svoboda/hamster_KO/datasets/hamster_testis_Mov10l.RNAseq/Data/Documentation'
features_coordinates='/common/DB/genome_reference/golden_hamster/MesAur1.0.GCA_000349665.1/ensembl.99.MesAur1.0.20200415.UCSCseqnames.gtf.gz'
features_name='ensembl.99.MesAur1.0.20200415.UCSCseqnames'
genes_info_path='/common/DB/genome_reference/golden_hamster/MesAur1.0.GCA_000349665.1/ensembl.99.MesAur1.0.20200415.UCSCseqnames.geneInfo.csv'
grouping_variables='genotype age'
counts_path='./ensembl.99.MesAur1.0.20200415.UCSCseqnames.counts.txt'
...
if(exploratory_analysis == "yes"){
  ...
  if(length(grouping_variables) == 1){
    ...
    pca_plot <-
      pca_plot +
      geom_point(aes_string(color = grouping_variables[1], fill = grouping_variables[1], shape = grouping_variables[2]), size = 7.5 + (7.5 * 0.5)) +
      guides(color = guide_legend(override.aes = list(shape = 23, size = 5)),
  ...
  pca_plot <-
    pca_plot +
    scale_fill_manual(values = c("Mov10l_KO" = "#ff0000", "Mov10l_WT" = "#0000ff")) + 
    scale_color_manual(values = c("Mov10l_KO" = "#ff0000", "Mov10l_WT" = "#0000ff")) + 
    theme_bw() +

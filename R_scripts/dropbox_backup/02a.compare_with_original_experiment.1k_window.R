...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/hamster_KO/datasets/hamster_testis_Mov10l.small_RNAseq.reseq/Analysis/expression.1k_window")
...
results_path <- file.path(exp, "Analysis/expression.1k_window")
...
# # save plot
# ggsave(filename = file.path(outpath, str_c("MesAur1.1k_windows",

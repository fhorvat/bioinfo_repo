...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/Analyses/circRNA_detection/datasets/Fugaku/CIRCexplorer2")
...
# counts table path
counts_tb_path <- file.path(inpath, "circularRNA_known.txt")

...
read_stats_sum_path <- args$read_stats_sum
tracks_URLs_path <- args$tracks_URLs

######################################################## READ DATA
# stats
stats_tbl <- readr::read_delim(read_stats_sum_path, delim = "\t")

# tracks
tracks_tbl <- readr::read_delim(file = tracks_URLs_path, col_names = F, delim = "\t")

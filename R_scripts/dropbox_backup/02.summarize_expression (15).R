...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/FLI_elements/MYSERV/expression/hamster_testis_Mov10l.RNAseq")
...
rpm_mean <- 
  ...
  dplyr::ungroup(.) %>% 
  tidyr::pivot_wider(id_cols = c("rmsk_name", "age"), names_from = genotype, values_from = RPM, names_prefix = "RPM.") %>% 

...
# save as table
readr::write_csv(as_tibble(gtf_3UTR), file.path(outpath, "mouse.mm10.ensembl.99.GRCm38.p6.20200415.UCSCseqnames.3pUTR.annotation.csv"))

# save as .bed
gtf_3UTR %T>% 
  rtracklayer::export.bed(., file.path(outpath, "mouse.mm10.ensembl.99.GRCm38.p6.20200415.UCSCseqnames.3pUTR.annotation.bed"))

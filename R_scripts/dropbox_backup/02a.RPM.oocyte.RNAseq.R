...
######################################################## PATH VARIABLES
# set inpath 
inpath <- "/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/raw_rmsk.expression/hamster_oocyte_Mov10l.RNAseq"
...
# save as table
readr::write_csv(RPM_summarized, file.path(outpath, str_c("LINE1s_subsets", "oocyte", "RNAseq", "RPM", "csv", sep = ".")))

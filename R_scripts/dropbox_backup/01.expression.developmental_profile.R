...
### in and out
# set inpath 
inpath <- "/common/WORK/fhorvat/Projekti/Svoboda/lncRNA_KO/Analysis/lnc1_paper/developmental_profile_expression"
...
### filter by gene ID (D6Ertd527e)
# set gene id
chosen_gene_id <- "ENSMUSG00000090891"

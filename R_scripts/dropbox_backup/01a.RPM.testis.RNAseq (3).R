...
inpath <- file.path(inpath, "raw_rmsk.expression/hamster_testis_Mov10l.RNAseq")
...
# save as table
readr::write_csv(RPM_summarized, file.path(outpath, str_c("IAPs_subsets", "testis", "RNAseq", "RPM", "csv", sep = ".")))

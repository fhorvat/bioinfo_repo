...
# i svaki put motivi su sve precizniji (bliže zajednièkom motivu). Dobijem
# consensus motive. 
...
consensus.motiffs <- MotiffsSequence(consensus.motiffs, 7)
...
consensus.motiffs.PWM <- consensus.motiffs.PWM[, 2:8]

...
######################################################## WORKING DIRECTORY
# set working dir
setwd("/common/WORK/fhorvat/Projekti/Svoboda/Dicer_Mili_KO/Analysis/RNAi_piRNA_paper/filter_LINE1")
...
line1_path <- file.path(inpath, "LINE1.4000nt_plus.annotated.csv")

...
fpkm_tidy %>%
  pivot_wider(-molecules_n,
              ...
              values_from = "fpkm") %T>%
  readr::write_csv(., file.path(outpath, "figure_2A_genes.GV.Wu_2019_unpub_GSE133748.FPKM.csv"))
...
fpkm_tidy %>%
  ...
  readr::write_csv(., file.path(outpath, "figure_2A_genes.GV.Wu_2019_unpub_GSE133748.number_of_molecules.from_ERCC.csv"))
...
# save
# ggsave(filename = file.path(outpath, "figure_2A_genes.GV.ERCC.molecules_n.fpkm.log10.plot.png"), plot = ln_plot, height = 10, width = 10)
...
# save
ggsave(filename = file.path(outpath, "figure_2A_genes.GV.ERCC.molecules_n.fpkm.log10.plot.labels.png"), plot = ln_plot_labels, height = 10, width = 10)

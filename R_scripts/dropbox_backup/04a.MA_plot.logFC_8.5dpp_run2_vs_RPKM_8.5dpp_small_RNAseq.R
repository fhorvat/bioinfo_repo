...
# FPKM table path
fpkm_tb_path.8.5dpp.pirna <- list.files(expression_path, ".*\\.FPKM_mean\\.csv$", full.names = T)
...
# set name
table_name <- "MesAur1.RNA_seq_Mov10l_logFC_8.5dpp_vs_piRNA_8.5dpp_RPKM"
...
cross_plot <-
  ...
  xlab(str_c("piRNA Mov10l1 WT RPKM - 8.5 dpp")) + 

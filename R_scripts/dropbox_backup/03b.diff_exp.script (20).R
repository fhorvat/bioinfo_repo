...
single_end=TRUE
threads=1
mapped_path='/common/WORK/fhorvat/Projekti/Svoboda/Ago2_KO/datasets/2019_Oct/Data/Mapped/STAR_mm10'
documentation_path='/common/WORK/fhorvat/Projekti/Svoboda/Ago2_KO/datasets/2019_Oct/Data/Documentation'

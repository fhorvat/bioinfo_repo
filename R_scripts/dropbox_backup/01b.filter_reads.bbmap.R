...
bam_paths <- c("/common/WORK/fhorvat/Projekti/Svoboda/Dicer_Mili_KO/Analysis/RNAi_piRNA_paper/LINE1_expression/datasets/Dicer_Mili_KO/Mapped/bbmap/s_GV_DBL_old_r1.PE.genome_sorted.bam", 
               "/common/WORK/fhorvat/Projekti/Svoboda/Dicer_Mili_KO/Analysis/RNAi_piRNA_paper/LINE1_expression.joined_rmsk_ID/datasets/Dicer_Mili_KO/Mapped/bbmap/s_GV_DBL_old_r1.PE.genome_sorted.bam")

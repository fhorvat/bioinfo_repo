...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/RNAi.Eliska/DicerX_viral_infection/datasets/2020_Apr.brain_spleen/Analysis/read_length_distribution")
...
library_path <- list.files(mapped_path, pattern = "library_hist\\..*\\.SE\\.txt", full.names = T)

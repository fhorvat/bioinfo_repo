...
experiment='mouse_mESC.MosIR.SOLiD.small_RNAseq.2011_May'
threads=1
mapped_path='/common/WORK/fhorvat/Projekti/Svoboda/antiviral_RNAi.Marcos/datasets/mouse_mESC.MosIR.SOLiD.small_RNAseq.2011_May/Data/Mapped/Shrimp_mm9/5_perfect_reads'
documentation_path='/common/WORK/fhorvat/Projekti/Svoboda/antiviral_RNAi.Marcos/datasets/mouse_mESC.MosIR.SOLiD.small_RNAseq.2011_May/Data/Documentation'
features_coordinates='/common/DB/genome_reference/mouse/mm9.NCBIM37.GCA_000001635.1/miRBase.18.mm9.20211006.gff3'
features_name='miRBase.18.mm9.20211006'
genes_info_path=''
grouping_variables='genotype transfection'
counts_path='./miRBase.18.mm9.20211006.counts.txt'
...
# create sample table
sample_table <- 
  tibble(sample_id = colnames(counts_tb)[colnames(counts_tb) != "gene_id"] %>% 

...
read_counts_paths <- file.path("/common/WORK/fhorvat/Projekti/Svoboda/accessory_data_sets/RNAseq", 
                               experiment_list, "Data/Mapped/STAR_mm10/5_rmsk_filtered_reads/filter_multimappers")
...
pheatmap::pheatmap(rpm_heatmap_tb,
                   ...
                   filename = file.path(outpath, str_c("heatmap.rmsk.L1_and_LTRs.20190306.10_multimappers.RPM.png")),
                   height = 20,
                   width = 20)

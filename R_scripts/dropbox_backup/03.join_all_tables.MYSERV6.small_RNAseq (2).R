...
rpm_paths <- rpm_paths[str_detect(rpm_paths, "hamster_oocyte_Mov10l.smallRNAseq")]
...
purrr::map(unique(rpm_tb_long$subset), function(element_subset){
  ...
  rpm_tb_hist %>% 
    ...
    readr::write_csv(x = ., file = file.path(outpath, str_c(element_subset, "hamster_ovaries_Mov10l.smallRNAseq", 
                                                            str_c(18, "to", 32, "nt"), 
                                                            "sense_antisense", 
  ...
  rpm_tb_hist_mean %>% 
    ...
    readr::write_csv(., file.path(outpath, str_c(element_subset, "hamster_ovaries_Mov10l.smallRNAseq", 
                                                 str_c(18, "to", 32, "nt"), 
                                                 "sense_antisense",

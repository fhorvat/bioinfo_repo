...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/piRNA_clusters.oocyte/map_clusters_to_Siomi/LINE1_expression")
...
# write
readr::write_csv(rpm_tb, file.path(outpath, "piRNA_clusters.oocyte_deduplexed.Siomi_LINE1_reads.RPM.csv"))

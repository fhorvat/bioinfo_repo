...
cluster_path <- file.path(inpath, "clusters.mESC_MosIR.RS7.RS10.union.rpm.3.width.50.mean_RPM.csv")

# mapped path
mapped_path <- "/common/WORK/fhorvat/Projekti/Svoboda/RNAi.Eliska/mESC_MosIR/datasets/Jul_2018/Data/Mapped/STAR_mm10/2_original_mapping"
...
######################################################## MAIN CODE
# comparison name
sample_name <- "mESC_MosIR.RS7.RS10"

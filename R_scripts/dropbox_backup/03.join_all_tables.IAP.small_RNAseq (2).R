...
rpm_tb_long <- 
  rpm_tb %>%
  dplyr::mutate(subset = factor(subset, levels = c("IAP_all", "IAP_LTRs", "IAP_ints", "IAPLTR3_4", "IAP_FLIs"))) %>% 
...
#     readr::write_csv(., file.path(outpath, str_c("IAPs_subsets.hamster_oocyte_Mov10l.deduplicated.smallRNAseq",

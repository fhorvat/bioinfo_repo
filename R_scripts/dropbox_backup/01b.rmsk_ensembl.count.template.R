...
# add read group
read_hits_sum1 <- read_hits_sum[ , read_group := ifelse("rRNA" %in% gene_biotype, "rRNA",
...
read_hits_final <- 
  ...
  readr::write_csv(x = ., path = file.path(outpath, str_c("smallRNA.perfect.21to23.summary.counts.dt.", experiment_name, bam_name, "csv", sep = "."))) 

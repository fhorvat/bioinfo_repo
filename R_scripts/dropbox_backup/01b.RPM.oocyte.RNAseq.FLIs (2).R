...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/IAP/expression/long_RNAseq/hamster_oocyte_Mov10l.RNAseq")
...
inpath <- file.path(inpath, "FLI_elements/IAP/expression/hamster_oocyte_Mov10l.RNAseq")
...
# save as table
readr::write_csv(RPM_summarized, file.path(outpath, str_c("IAPs_subsets", "oocyte", "RNAseq", "RPM", "complete", "20201102", "csv", sep = ".")))

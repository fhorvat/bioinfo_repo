...
#                                            singleEnd = FALSE,
#                                            ignore.strand = TRUE)
# saveRDS(se, file = file.path(outpath, "ensembl.GRCm38.89.tx.CNOT6L.summarizedOverlaps.RDS"))

# read summarizedExperiment from RDS file
se <- readRDS(file = file.path(outpath, "ensembl.GRCm38.89.tx.CNOT6L.summarizedOverlaps.RDS"))
...
fpkm_df <-
  ...
  readr::write_csv(., path = file.path(outpath, "ensembl.GRCm38.89.tx.CNOT6L.avgFPKM.csv"))

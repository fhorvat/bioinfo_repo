...
######################################################## WORKING DIRECTORY
# set working dir
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/chinese_hamster.CriGri_PICR")
...
# get sequences 
line1_sample_seq <- Biostrings::getSeq(BSgenome.Cgriseus.Ensembl.CriGriPICR, line1_sample_gr)

...
setwd("/common/WORK/fhorvat/Projekti/Svoboda/Analyses/GenomeResearch_2016/review/confusion_heatmap/")
...
if(makeNewSample) pdf(file=paste("MT_confusionmatrix_", ts, ".pdf", sep = ""), width=9, height=8, onefile=FALSE)
...
moltenConservationProfiles$LTR <- factor(moltenConservationProfiles$LTR, levels = heatmapOrderManual)
...
#  geom_smooth(se = FALSE, span = 0.015) 
  ggsave(paste("ConservationProfiles", tsHist, ".pdf", sep = ""), width = 7, height = 14)

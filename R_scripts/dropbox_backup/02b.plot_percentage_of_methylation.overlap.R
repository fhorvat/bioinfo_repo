...
# save as table
readr::write_csv(plot_tb, file.path(outpath, str_c("methylation_percentage", "repeat_classes", "overlap_coverage_filtering", "csv", sep = ".")))
...
ggsave(plot = bar_plot,
       filename = file.path(outpath, str_c("barplot", "methylation_percentage", "repeat_classes", "overlap_coverage_filtering", "png", sep = ".")),
       width = 12, height = 10)
...
#        filename = file.path(outpath, str_c("violin", "methylation_percentage", "repeat_classes", "overlap_coverage_filtering", "png", sep = ".")),
#        width = 12, height = 10)

...
# LINE1s coordinates
line1_path <- file.path(documentation_path, "LINE1.4000nt_plus.ORFs.annotated_exons_and_L1Base.csv")
...
line1_out <- 
  ...
  readr::write_csv(., path = file.path(outpath, str_c("LINE1.5k_to_7k.Dicer_Mili_KO.coverage.csv")))

...
saveWorkbook(wb_individual, file.path(outpath, str_c("all_LTR_classes", "small_RNAseq", "all_samples_RPM", "20201107", "xlsx", sep = ".")), overwrite = TRUE)
saveWorkbook(wb_mean, file.path(outpath, str_c("all_LTR_classes", "small_RNAseq", "mean_RPM", "20201107", "xlsx", sep = ".")), overwrite = TRUE)

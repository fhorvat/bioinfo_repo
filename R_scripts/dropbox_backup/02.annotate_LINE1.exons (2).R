...
# reduced exons path
exons_path <- file.path(genome_dir, "ensembl.99.CHOK1GS_HDv1.20200423.UCSCseqnames.reducedExons.RDS")

# gene info path
genes_info_path <- file.path(genome_dir, "ensembl.99.CHOK1GS_HDv1.20200423.UCSCseqnames.geneInfo.csv")

...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/FLI_elements/LINE/annotation/blast_ORFs_L1")
...
# dplyr::filter(identity_perc >= 98)
# dplyr::filter(query_alignment_width >= width(orfs_fasta) - 20)

...
######################################################## PATH VARIABLES
# set inpath 
inpath <- "/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/FLI_elements/IAP/expression/hamster_testis_Mov10l.RNAseq"
...
# save as table
readr::write_csv(RPM_summarized, file.path(outpath, str_c("IAPs_subsets", "testis", "RNAseq", "RPM", "complete", "csv", sep = ".")))

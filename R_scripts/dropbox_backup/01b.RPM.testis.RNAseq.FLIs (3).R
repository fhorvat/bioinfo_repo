...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/IAP/expression/long_RNAseq/hamster_testis_Mov10l.RNAseq")
...
inpath <- file.path(inpath, "FLI_elements/IAP/expression/hamster_testis_Mov10l.RNAseq")
...
subset_rpms_path <- file.path(outpath, "IAPs_subsets.testis.RNAseq.RPM.csv")
...
# save as table
readr::write_csv(RPM_summarized, file.path(outpath, str_c("IAPs_subsets", "testis", "RNAseq", "RPM", "complete", "20201102", "csv", sep = ".")))

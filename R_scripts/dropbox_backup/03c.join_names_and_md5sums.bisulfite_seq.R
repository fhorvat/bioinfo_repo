...
# file names path
file_names_path <- file.path(inpath, "file_names.oocyte.bisulfite_seq.csv")

# md5 sums path
md5_sums_path <- file.path(inpath, "file_md5sums.oocyte.bisulfite_seq.csv")
...
file_md5 <- 
  ...
  readr::write_csv(., file.path(outpath, "file_names.md5_sums.oocyte.bisulfite_seq.csv"))

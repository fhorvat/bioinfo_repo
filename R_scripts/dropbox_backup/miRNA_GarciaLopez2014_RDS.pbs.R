...
### DATE: 18. 07. 2017.  
### AUTHOR: Filip Horvat
### qsub -V -q MASTER -l select=1:mem=200gb -N GarciaLopez -j oe -o /common/WORK/fhorvat/Projekti/Svoboda/Analyses/smallRNA/GarciaLopez_2014_GSE45983 miRNA_GarciaLopez2014_RDS.pbs.R

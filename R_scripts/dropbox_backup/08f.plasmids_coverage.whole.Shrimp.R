...
# sample bam path
sample_bam_path <- list.files(path = "/common/WORK/fhorvat/Projekti/Svoboda/smallRNASeq_2018/NIH3T3_transfected.2018/Data/Mapped/shrimp.only_plasmids", 
...
# experiment paths
experiment_paths <- 
  "/common/WORK/fhorvat/Projekti/Svoboda/smallRNASeq_2018/NIH3T3_transfected.2018/Data/Mapped/shrimp.only_plasmids" %>% 
...
for(bam_path in bam_paths){
  ...
  ggsave(plot = coverage_plot,
         filename = file.path(outpath, "coverage_plots/whole_plasmids/only_plasmids/shrimp.only_plasmids", str_c(bam_name, "shrimp.whole.coverage.RPM.png", sep = ".")),
         width = 15,
         height = 10)

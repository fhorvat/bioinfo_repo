...
#   facet_grid(stage ~ .)
# 
# ggsave(filename = paste0("./coverage/", element_name, "_summedCoverage.pdf"), 
...
# plotCumFPKMBinArea(10000)
# plotCumFPKMBinArea(2000)
  
# all_coverage_counts_df_merged_MT2_full <- all_coverage_counts_df_merged
# element_width_MT2_full <- element_width
# element_name_MT2_full <- element_name
# 
# all_coverage_counts_df_merged_MT2_solo <- all_coverage_counts_df_merged
# element_width_MT2_solo <- element_width
# element_name_MT2_solo <- element_name

# all_coverage_counts_df_merged_ORR1A0_solo <- all_coverage_counts_df_merged
# element_width_ORR1A0_solo <- element_width
# element_name_ORR1A0_solo <- element_name
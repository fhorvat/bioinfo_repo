...
single_end=TRUE
threads=1
mapped_path='/common/WORK/fhorvat/Projekti/Svoboda/RNAi.Eliska/mESC_MosIR/datasets/Jul_2018/Data/Mapped/STAR_mm10'
documentation_path='/common/WORK/fhorvat/Projekti/Svoboda/RNAi.Eliska/mESC_MosIR/datasets/Jul_2018/Data/Documentation'
...
genes_info_path=''
grouping_variables=c('genotype', 'transfection')
...
pca_plot <-
  pca_plot +
  scale_color_manual(values = c("WT" = "#619CFF", "DicerHAoo" = "#F8766D", "DicerHAoo_PKR" = "#00BA38")) +
  scale_fill_manual(values = c("WT" = "#619CFF", "DicerHAoo" = "#F8766D", "DicerHAoo_PKR" = "#00BA38")) + 
  theme_bw() +

...
tracks_tbl <-
  ...
  dplyr::mutate(raw.coverage = ifelse("raw.coverage" %in% colnames(.), raw.coverage, NA), 
                RPM_scaled.coverage = ifelse("RPM_scaled.coverage" %in% colnames(.), RPM_scaled.coverage, NA), 
                raw.individual_reads = ifelse("raw.individual_reads" %in% colnames(.), RPM_scaled.coverage, NA)) %>% 

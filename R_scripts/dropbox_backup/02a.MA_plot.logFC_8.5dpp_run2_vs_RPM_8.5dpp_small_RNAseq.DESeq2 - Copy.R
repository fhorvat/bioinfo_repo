...
# results path
results_path.8.5dpp <- list.files(expression_path, ".*\\.all_results\\.xlsx$", full.names = T, recursive = T)
results_path.8.5dpp <- results_path.8.5dpp[!str_detect(results_path.8.5dpp, "with_fpkm_limit")]

# significant results path 
results_path.8.5dpp.sign <- list.files(expression_path, ".*\\.significant_results\\.xlsx$", full.names = T, recursive = T)
results_path.8.5dpp.sign <- results_path.8.5dpp.sign[!str_detect(results_path.8.5dpp.sign, "with_fpkm_limit")]

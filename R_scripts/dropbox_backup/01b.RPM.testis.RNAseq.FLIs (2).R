...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/LINE1/expression/long_RNAseq/hamster_testis_Mov10l.8.5dpp.RNAseq")
...
inpath <- file.path(inpath, "FLI_elements/LINE/expression/hamster_testis_Mov10l.8.5dpp.RNAseq")
...
subset_rpms_path <- file.path(outpath, "LINE1s_subsets.testis.8.5dpp.RNAseq.RPM.csv")
...
# save as table
readr::write_csv(RPM_summarized, file.path(outpath, str_c("LINE1s_subsets", "testis", "8.5dpp", "RNAseq", "RPM", "complete", "20201102", "csv", sep = ".")))

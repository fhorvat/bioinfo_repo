...
ggsave(plot = coverage_plot,
       filename = file.path(outpath, str_c("MosIR_coverage.all_reads.whole_plasmid.RPM.png", sep = ".")),
       width = 8,
       height = 15)
...
# save
ggsave(plot = coverage_plot,
       filename = file.path(outpath, str_c("MosIR_coverage.all_reads.repeat_only.RPM.png", sep = ".")),
       width = 8,
       height = 15)

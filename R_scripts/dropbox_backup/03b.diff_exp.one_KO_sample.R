...
experiment='hamster_testis_Mov10l.0.5dpp.RNAseq'
single_end=TRUE
threads=1
mapped_path='/common/WORK/fhorvat/Projekti/Svoboda/hamster_KO/datasets/hamster_testis_Mov10l.0.5dpp.RNAseq/Data/Mapped/STAR_mesAur1'
documentation_path='/common/WORK/fhorvat/Projekti/Svoboda/hamster_KO/datasets/hamster_testis_Mov10l.0.5dpp.RNAseq/Data/Documentation'
...
results_groups='Mov10l_KO_0.5dpp,Mov10l_WT_0.5dpp'
...
lfc_cut=as.numeric('0.5')
padj_cut=as.numeric('0.01')
fpkm_cut=as.numeric('0')
results_groups <- str_split(results_groups, pattern = " ") %>% unlist()
grouping_variables <- str_split(grouping_variables, pattern = " ") %>% unlist()
...
sample_table_dds <-
  ...
  .[sample_id != "s_testis_Mov10l_KO_0.5dpp_So843-M5_r2.SE", ]  %>% 

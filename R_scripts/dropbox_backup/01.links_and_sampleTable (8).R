...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/lncRNA_KO/datasets/Lnc5_KO.2020_Aug/Data/Documentation")
...
# raw files path
raw_path <- "/common/RAW/Svoboda/mouse.Ln5.Ovo.2020/joined_lanes/Lnc5_KO"

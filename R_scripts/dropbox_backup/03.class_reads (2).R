...
bam_path <- "%BAM_PATH"
bam_path <- "/common/WORK/fhorvat/Projekti/Svoboda/smallRNASeq_2018/Eliska_mESC_MosIR/Data/Mapped/STAR_mm10_new/s_RSP_Mos_r1.SE.genome.Aligned.sortedByCoord.out.bam"
...
read_hits_final <- 
  ...
  readr::write_csv(x = ., path = file.path(outpath, str_c("smallRNA.all.21to23", experiment_name, bam_name, "csv", sep = "."))) 

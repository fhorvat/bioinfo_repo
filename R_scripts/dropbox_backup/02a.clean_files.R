...
ensembl_gtf_UCSC <-
  ...
  dplyr::mutate(X1 = factor(x  = X1, levels = UCSC_faidx$UCSC_name)) %>%
  dplyr::arrange(X1) %T>%
...
## Ensembl versions
ensembl_url <-
  tibble(ens_version = c(96, 95, 94, 93, 92, 91, 89, 86),
         date = c("Apr 2019", "Jan 2019", "Oct 2018", "Jul 2018", "Apr 2018", "Dec 2017", "May 2017", "Oct 2016"),
         URL_archive = c("http://apr2019.archive.ensembl.org",

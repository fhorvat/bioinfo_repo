...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/FLI_elements/MYSERV/expression/hamster_testis_Mov10l.0.5dpp.RNAseq")
...
######################################################## MAIN CODE
### set element name
element_name <- "MYSERV.repeatModeler"
...
# save
readr::write_csv(rpm_mean, file.path(outpath, str_c(element_name, "FLI_elements.RPM", "testis.0.5dpp", "csv", sep = ".")))

...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/LINE1/expression/long_RNAseq/hamster_oocyte_Mov10l.RNAseq")
...
# save as table
readr::write_csv(RPM_summarized, file.path(outpath, str_c("LINE1s_subsets", "oocyte", "RNAseq", "RPM", "complete", "20201104", "csv", sep = ".")))

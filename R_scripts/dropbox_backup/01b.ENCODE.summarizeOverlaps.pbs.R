...
# set experiment name
experiment <- "ENCODE_2014_Nature_GSE49417"
experiment_name <- "ENCODE_2014_mouse"
...
saveRDS(se, file = file.path(outpath, basename(exons_path) %>% str_replace(., ".reducedExons.rmskFiltered.RDS", str_c(experiment_name, ".rmskFiltered.se.RDS"))))

...
r_outpath <- "/common/WORK/fhorvat/Projekti/Svoboda/CNOT6L/Analysis/CNOT6L_2017/spliced_reads/RData/Count_ExonIntron_RData"
...
ooreg_path <- "/common/WORK/fhorvat/Projekti/Svoboda/CNOT6L/Analysis/CNOT6L_2017/spliced_reads/documentation/CNOT6L_MII_OocyteRegions_lower5.bed"
...
cnts <- foreach(chr = chrs$chr)%dopar%{
  ...
  #   - uniquely mapped to exons/introns
  #   - uniquely mapped to introns of non-oocyte regions
  #   - uniquely mapped to introns of non-repeatMasker regoins
  #   - uniquely mapped to 1kb bins 10kb from gene ends
  # - repeats tables = read counts/weights of reads:
  #   - uniqeuly mapped to repeatMasker regions
  # - tabs = table of read statistics, is each read mapped to:
  #   - exon
  #   - intron
  #   - repeatMasker region
  #   - splice donor

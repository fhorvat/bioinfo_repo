...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/piRNA_clusters/count_N_in_genome")
...
# .gff file path
gff_path <- list.files(expression_path, ".*\\.gff$", full.names = T)

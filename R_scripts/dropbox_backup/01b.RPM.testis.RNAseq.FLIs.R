...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/LINE1/expression/long_RNAseq/hamster_testis_Mov10l.RNAseq")
...
inpath <- file.path(inpath, "FLI_elements/LINE/expression/hamster_testis_Mov10l.RNAseq")
...
# save as table
readr::write_csv(RPM_summarized, file.path(outpath, str_c("LINE1s_subsets", "testis", "RNAseq", "RPM", "complete", "20201102", "csv", sep = ".")))

...
inpath <- file.path(inpath, "raw_rmsk.expression/hamster_testis_Mov10l.8.5dpp.RNAseq")
...
# save as table
readr::write_csv(RPM_summarized, file.path(outpath, str_c("LINE1s_subsets", "testis", "8.5dpp", "RNAseq", "RPM", "csv", sep = ".")))

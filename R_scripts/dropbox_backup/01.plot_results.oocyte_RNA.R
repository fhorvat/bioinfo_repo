...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/deviaTE.CriGriPICR.LINE1_consensus")
...
# deviate table path
deviate_tb_path <- 
  list.files(inpath, "*.raw", full.names = T) %>% 
  .[!str_detect(., "F66|F53")]

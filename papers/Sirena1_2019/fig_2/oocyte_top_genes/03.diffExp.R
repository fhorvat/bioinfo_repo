...
### experiment
# set experiment name
experiment <- "Smallwood_2011_NatGenet_PRJEB2547"
...
setwd(file.path("/common/WORK/fhorvat/Projekti/Svoboda/accessory_data_sets/RNAseq", experiment, "Analysis/expression"))

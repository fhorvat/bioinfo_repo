...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/lncRNA_KO/Analysis/lnc1_paper/rodents_evolution/lnc1_locus/other/flanking_genes.mRNA/blat")
...
# inter exons bed 
inter_exons_bed_path <- list.files(path = file.path(inpath, ".."), pattern = ".*\\.bed", full.names = T)

...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/piRNA_clusters.oocyte/oocyte_expression/piwil3")
...
cluster_path <- file.path(inpath, 
                          ...
                          "piRNA_clusters.oocyte_PIWIL3.rpkm_cutoff.1.20210513.RPKM.csv")

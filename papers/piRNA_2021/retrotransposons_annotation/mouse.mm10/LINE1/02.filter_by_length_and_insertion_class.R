...
######################################################## WORKING DIRECTORY
# set working dir
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/mouse.mm10/LINE1")
...
# write as fasta
seq_msa@unmasked %>%
  Biostrings::writeXStringSet(., file = file.path(outpath, str_c("LINE1.with_both_ORFs", "together", "msa.fasta", sep = ".")))
...
# save with labels
png(filename = file.path(outpath, str_c("LINE1.with_both_ORFs", "phylo_tree", "ClustalO.msa", "labels", "png", sep = ".")), width = 2000, height = 2000, units = "px")

...
ltr_tb_path <- file.path(inpath, "LTRs.random_200_per_repName.20210107.csv")
...
ggsave(plot = sub_rate_boxplot, 
       filename = file.path(outpath, str_c("LTRs.random_200_per_subFamily.20210107", "IAP", "boxplot.png", sep = ".")), 
       width = 20, 
       height = 10)

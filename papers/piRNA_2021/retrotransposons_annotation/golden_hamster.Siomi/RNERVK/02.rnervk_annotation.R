...
######################################################## WORKING DIRECTORY
# set working dir
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/RNERVK/annotation")
...
rmsk_tb_filt <-
  ...
  dplyr::arrange(-width) %T>%
  readr::write_csv(., file = file.path(outpath, "RNERVK23-int.longer_than_1kb.csv"))
...
rtracklayer::export.bed(rmsk_bed, file.path(outpath, "RNERVK23-int.longer_than_1kb.bed"))
...
# rmsk_tb_filt <-
#   rmsk_tb %>%
#   dplyr::filter(str_detect(repName, "RNERVK23-int")) %>%

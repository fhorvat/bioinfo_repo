...
purrr::map(animals_list, function(animal){
  ...
  ggsave(plot = sub_rate_boxplot, 
         filename = file.path(outpath, str_c("LINE1s.random_200_per_repSubfamily.200805", animal, "complete.boxplot.png", sep = ".")), 
         width = 30, 
         height = 10)
  
  # save plot to common path too
  ggsave(plot = sub_rate_boxplot, 
         filename = file.path(common_outpath, str_c("LINE1s.random_200_per_repSubfamily.200805", animal, "complete.boxplot.png", sep = ".")), 
         width = 30, 
         height = 10)

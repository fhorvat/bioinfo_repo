...
######################################################## MAIN CODE
# set classes
comboClasses <- list("MLT1" = c("MLT1O", "MLT1N2", "MLT1M", "MLT1L", "MLT1K", "MLT1J", "MLT1J1", "MLT1J2", "MLT1I", "MLT1H", "MLT1H1", "MLT1H2", 
                                "MLT1G", "MLT1G1", "MLT1G3", "MLT1F", "MLT1F1", "MLT1F2", "MLT1E", "MLT1E1", "MLT1E1A", "MLT1E2", "MLT1E3", 
                                "MLT1D", "MLT1C", "MLT1B", "MLT1A", "MLT1A0", "MLT1A1"), 
                     "MLT2" = c("MLT2F", "MLT2E", "MLT2D", "MLT2C1", "MLT2C2", "MLT2B1", "MLT2B2", "MLT2B3", "MLT2B4", "MLT2B5"), 
                     "ORR1G" = c("ORR1G"),
                     "ORR1F" = c("ORR1F"),
                     "ORR1E" = c("ORR1E"),
...
ggsave(plot = sub_rate_boxplot, 
       filename = file.path(outpath, str_c("LTRs.random_200_per_subFamily.200730", "MaLR", "joined_MLT", "boxplot.png", sep = ".")), 
       width = 20, 
       height = 10)

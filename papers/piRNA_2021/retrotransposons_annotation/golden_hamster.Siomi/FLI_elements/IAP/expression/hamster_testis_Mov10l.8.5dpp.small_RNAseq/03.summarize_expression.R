...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/FLI_elements/IAP/expression/hamster_testis_Mov10l.8.5dpp.small_RNAseq")
...
purrr::map(names(read_lengths), function(rlen){
  ...
  saveWorkbook(wb, file.path(outpath, str_c(element_name, "FLI_elements.RPM", "smallRNA", "testis", "xlsx", sep = ".")), overwrite = TRUE)

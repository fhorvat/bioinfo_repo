...
ggsave(plot = baseplot, 
       filename = file.path(outpath, str_c("LINE1.FLI_consensus.methylation.barplot", "4_reads_filt", "png", sep = ".")), 
       width = 15, height = 7.5)
...
# save plot
ggsave(plot = baseplot, 
       filename = file.path(outpath, str_c("LINE1.FLI_consensus.methylation.position_barplot", "4_reads_filt", "png", sep = ".")), 
       width = 15, height = 7.5)

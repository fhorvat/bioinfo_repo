...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.Siomi_assembly/FLI_elements/MYSERV/methylation/mapped/Nov_2020/FLI_consensus")
...
ggsave(plot = baseplot, 
       filename = file.path(outpath, str_c("MYSERV.FLI_consensus.methylation.barplot", "4_reads_filt", "png", sep = ".")), 
       width = 15, height = 7.5)
...
# save plot
ggsave(plot = baseplot, 
       filename = file.path(outpath, str_c("MYSERV.FLI_consensus.methylation.position_barplot", "4_reads_filt", "png", sep = ".")), 
       width = 15, height = 7.5)

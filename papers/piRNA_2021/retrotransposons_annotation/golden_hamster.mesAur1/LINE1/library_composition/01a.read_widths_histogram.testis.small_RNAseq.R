...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.MesAur1/LINE1/library_composition")
...
######################################################## PATH VARIABLES
# set inpath 
inpath <- "/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.MesAur1/raw_rmsk.expression/hamster_testis_Mov10l.small_RNAseq"
...
mapped_path <- file.path(base_path, "Data/Mapped/STAR_mesAur1.multimappers")
library_size_path <- file.path(mapped_path, "library_sizes.txt")

# gene info path
gene_info_path <- "/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.MesAur1/raw_rmsk.expression"
gene_info_path <- file.path(gene_info_path, "rmsk.MesAur1.0.20160612.RefSeq.clean.SINE_LINE_LTRs.geneInfo.csv")

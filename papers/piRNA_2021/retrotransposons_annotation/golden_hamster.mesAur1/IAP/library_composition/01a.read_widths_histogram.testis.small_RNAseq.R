...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/piRNA.Zuzka/Analysis/2020_paper/retrotransposons_annotation/golden_hamster.MesAur1/IAP/library_composition")
...
# # set name 
# plot_name <- "04.IAPLTR3_4.LTRs_ints"
# 
# # filter table
# expression_tb <- 
#   expression_tb_full %>% 

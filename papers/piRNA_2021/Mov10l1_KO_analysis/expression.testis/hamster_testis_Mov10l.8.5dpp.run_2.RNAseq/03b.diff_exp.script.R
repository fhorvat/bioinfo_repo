...
single_end=TRUE
threads=1
mapped_path='/common/WORK/fhorvat/Projekti/Svoboda/hamster_KO/datasets/hamster_testis_Mov10l.8.5dpp.run_2.RNAseq/Data/Mapped/STAR_mesAur1'
documentation_path='/common/WORK/fhorvat/Projekti/Svoboda/hamster_KO/datasets/hamster_testis_Mov10l.8.5dpp.run_2.RNAseq/Data/Documentation'
...
results_groups='Mov10l1_KO_8.5dpp,Mov10l1_WT_8.5dpp'
...
padj_cut=as.numeric('0.1')
fpkm_cut=as.numeric('1')
...
if(exploratory_analysis == "yes"){
  ...
  pca_plot <-
    pca_plot +
    scale_fill_manual(values = c("Mov10l1_WT" = "#7f7f7f", "Mov10l1_KO" = "#ff0000")) + 

...
# fpkm path
fpkm_path <- file.path(inpath, "ensembl.99.GRCm38.p6.20200415.UCSCseqnames.Ago.Sirena.short.FPKM.csv")
...
count_tb <- 
  ...
  readr::write_csv(., file.path(outpath, "ensembl.99.GRCm38.p6.20200415.UCSCseqnames.Ago_short.n_molecules.csv"))
...
fpkm_mean <- 
  ...
  readr::write_csv(., file.path(outpath, "chosen_genes.ensembl.99.GRCm38.p6.20200415.UCSCseqnames.Ago_short.n_molecules.csv"))
...
plot_fpkm <- 
  ...
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), 
        legend.position = "none") +
  ggsave(filename = file.path(outpath, "chosen_genes.ensembl.99.GRCm38.p6.20200415.UCSCseqnames.Ago_short.n_molecules.png"),
         height = 10, width = 12)

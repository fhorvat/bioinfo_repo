...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/accessory_data_sets/RNAseq/Graf_2014_ProcNatlAcadSciUSA_GSE52415/Data/Mapped/STAR_bosTau9")
...
exons_path <- list.files(path = genome_dir, pattern = "ensembl\\.96.*reducedExons\\.RDS$", full.names = T)

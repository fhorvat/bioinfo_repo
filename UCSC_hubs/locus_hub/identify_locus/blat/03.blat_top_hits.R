...
######################################################## WORKING DIRECTORY
setwd("/common/WORK/fhorvat/Projekti/Svoboda/ovomucin_KO/Analysis/2021_paper/ovomucin_locus/AcoCah/identify_locus/blat")
...
# fasta index path
fasta_index_path <- list.files(path = file.path(blat_path, "../flanking_genes.mm10"), pattern = ".*\\.fa\\.fai$", full.names = T)
